class AzucarMorenaV2 extends Agent {
    ...
    compute(board, timeRemaining) {
        ...
        // MÁS TIEMPO PARA CALIDAD (factor 0.55, tope 9.5s)
        this.timeLimit =
            Math.min(
                timeRemaining * 0.55,
                9.5
    ...
    configureStrategy(
        ...
        if (this.size <= 10) {
            ...
            if (this.initialTime <= 5) {
                ...
                // PARÁMETROS EXTREMADAMENTE ROBUSTOS PARA 10x10 CON POCO TIEMPO
                this.openingPercent = 0.003;       // casi nada de aleatoriedad
                this.minimaxStartPercent = 0.15;   // Minimax casi desde el principio
                this.baseDepth = 10;               // profundidad base altísima
                this.endDepth = 16;                // profundidad final extrema
            }
        }
        ...
        // =====================================
            ...
            if (this.initialTime <= 5) {
                ...
                // PARÁMETROS ROBUSTOS PARA TABLEROS GRANDES CON POCO TIEMPO
                // Se reduce la aleatoriedad y se profundiza un poco más, pero manteniendo factibilidad
                this.openingPercent = 0.025;
                this.minimaxStartPercent = 0.65;
                this.baseDepth = 4;      // +1 nivel
                this.endDepth = 7;       // +2 niveles al final
                // No se activa FAST_MODE extra porque ya lo está, pero se mantienen anchos dinámicos
            }
        }
    ...
    // =====================================================
    // ORDER (MÁS MOVIMIENTOS EVALUADOS)
    // =====================================================
