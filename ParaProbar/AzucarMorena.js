class AzucarMorena extends Agent {
    ...
    configureStrategy(
        ...
        if (this.size <= 10) {
            ...
            this.openingPercent = 0.008;    // menos aleatorio
            ...
            if (this.initialTime <= 5) {
                ...
                // PARÁMETROS MUY ROBUSTOS PARA 10x10 CON POCO TIEMPO
                this.openingPercent = 0.005;       // aún menos aleatorio
                this.minimaxStartPercent = 0.40;   // entrar a minimax muy temprano
                this.baseDepth = 8;                // profundidad base alta
                this.endDepth = 14;                // profundidad final muy alta
            }
        }
